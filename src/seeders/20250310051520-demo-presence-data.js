    ...
    await queryInterface.bulkInsert('presences', [
      {
        ...
        userId: 'e755876a-900e-45a2-91dd-71df5743c7c0', // Jane Smith
        presenceCount: 10,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        userId: '78ada912-6faa-4776-bd13-3600c249c3d9', // John Doe
        presenceCount: 5,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        userId: '8ccbb20d-3de8-4659-9690-ae1d5c6d0719', // Alex Taylor
        presenceCount: 8,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
